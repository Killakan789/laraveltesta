...
--
-- Структура таблицы `apis`
--

CREATE TABLE `apis` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `t_body` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Дамп данных таблицы `apis`
--

INSERT INTO `apis` (`id`, `t_body`, `status`, `created_at`, `updated_at`) VALUES
(1, '{\"id\":\"12345-7891234567\",\"operation\":\"pay\",\"status\":\"fail\"}', 1, '2021-07-07 15:15:09', '2021-07-07 15:15:09'),
(2, 'null', 0, '2021-07-07 15:20:20', '2021-07-07 15:20:20'),
(3, '{\"id\":\"12345-7891234567\",\"operation\":\"pay\",\"status\":\"fail\"}', 0, '2021-07-07 15:25:44', '2021-07-07 15:25:44');
...
--
-- AUTO_INCREMENT для таблицы `apis`
--
ALTER TABLE `apis`
